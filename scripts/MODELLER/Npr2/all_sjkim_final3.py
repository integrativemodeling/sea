...
for files in os.listdir('.'):
    if fnmatch.fnmatch(files, 'Npr2.B*.pdb'):
        print files
        mdl = model(env, file=files)
        mdl.rename_segments('A', 563)
        mdl.write(files)
...
#
#e = environ()
#a = alignment(e, file='all_align_1xks_final3.ali')
#
...
##pylab.legend(loc=0)
#pylab.savefig('all_dope_profile_final3_N133N.png', dpi=150)
