...
#It begin5s from here
aln = alignment(env)
aln.append(file='all_align_begin5.ali')
aln.write(file='all_align_final5.ali', alignment_format='PIR')
aln.write(file='all_align_final5.pap', alignment_format='PAP')
aln.id_table(matrix_file='all_align_final5.mat')
aln.check()

#exit()
######################### 4. model-single.py ########################
a = automodel(env, 
              alnfile='all_align_final5.ali',
...
#
#e = environ()
#a = alignment(e, file='all_align_1xks_final5.ali')
#
...
##pylab.legend(loc=0)
#pylab.savefig('all_dope_profile_final5_N133N.png', dpi=150)
